        ...
        return [
            ...
            [
                ...
                'field' => [
                    ...
                    'default' => Defaults::data('collections', true)->get('seo_generate_social_images'),
                    'localizable' => true,
                    'listable' => 'hidden',
                ],
            ],
        ...
        $fields = [
            ...
            [
                ...
                'field' => [
                    ...
                    'default' => Defaults::data('collections', true)->get('seo_twitter_card'),
                    'listable' => 'hidden',
                    'localizable' => true,
                ],
            ],
        ...
        return [
            ...
            [
                ...
                'field' => [
                    ...
                    'default' => Defaults::data('collections', true)->get('seo_canonical_type'),
                    'listable' => 'hidden',
                    'localizable' => true,
                ],
            ],
        ...
        return [
            ...
            [
                ...
                'field' => [
                    ...
                    'default' => Defaults::data('collections', true)->get('seo_noindex'),
                    'listable' => 'hidden',
                    'localizable' => true,
                    'width' => 50,
                ],
            ...
            [
                ...
                'field' => [
                    ...
                    'default' => Defaults::data('collections', true)->get('seo_nofollow'),
                    'listable' => 'hidden',
                    'localizable' => true,
                    'width' => 50,
                ],
        ...
        return [
            ...
            [
                ...
                'field' => [
                    ...
                    'default' => Defaults::data('collections', true)->get('seo_sitemap_priority'),
                    'clearable' => false,
                    'multiple' => false,
                    'searchable' => false,
                    'taggable' => false,
            ...
            [
                ...
                'field' => [
                    ...
                    'default' => Defaults::data('collections', true)->get('seo_sitemap_change_frequency'),
                    'clearable' => false,
                    'multiple' => false,
                    'searchable' => false,
                    'taggable' => false,
