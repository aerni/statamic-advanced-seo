        ...
        $fields = [
            ...
            [
                ...
                'field' => [
                    ...
                    'type' => 'seo_source',
                    'default' => in_array($this->getRawFromCascade('seo_og_title'), ['@auto', '@null', null]) ? '@auto' : '@default',
                    'auto' => 'seo_title',
                    'localizable' => true,
                    'classes' => 'text-fieldtype',
                    'field' => [
            ...
            [
                ...
                'field' => [
                    ...
                    'type' => 'seo_source',
                    'default' => in_array($this->getRawFromCascade('seo_og_description'), ['@auto', '@null', null]) ? '@auto' : '@default',
        ...
        $fields = [
            ...
            [
                ...
                'field' => [
                    ...
                    'type' => 'seo_source',
                    'default' => in_array($this->getRawFromCascade('seo_twitter_title'), ['@auto', '@null', null]) ? '@auto' : '@default',
                    'auto' => 'seo_title',
                    'localizable' => true,
                    'classes' => 'text-fieldtype',
                    'field' => [
            ...
            [
                ...
                'field' => [
                    ...
                    'type' => 'seo_source',
                    'default' => in_array($this->getRawFromCascade('seo_twitter_description'), ['@auto', '@null', null]) ? '@auto' : '@default',
                    'auto' => 'seo_description',
                    'localizable' => true,
                    'classes' => 'textarea-fieldtype',
                    'field' => [
