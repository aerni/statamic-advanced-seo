...
return [
    ...
    'upgrade_prompt' => 'You are using Advanced SEO Free. <a href=":url" target="_blank" class=":classes">Upgrade to Pro</a> for sitemaps, multi-site, AI, permissions, and more.',
    ...
    'pro_feature_sitemaps_description' => 'XML sitemaps for collections, taxonomies, and custom routes.',
    'pro_feature_multi_site' => 'Multi-Site',
    'pro_feature_multi_site_description' => 'Localized SEO defaults with origin inheritance.',
    'pro_feature_ai' => 'AI Content Generation',
    'pro_feature_ai_description' => 'Generate meta titles and descriptions with AI.',
    'pro_feature_social_images' => 'Social Images',
    'pro_feature_social_images_description' => 'Automated social image generation with customizable themes.',
    'pro_feature_permissions' => 'Permissions',
    'pro_feature_permissions_description' => 'Fine-grained control over who can configure and edit SEO.',
    'pro_feature_graphql' => 'GraphQL',
    'pro_feature_graphql_description' => 'Full GraphQL support for headless setups.',
    'pro_feature_eloquent' => 'Eloquent Driver',
    'pro_feature_eloquent_description' => 'Store SEO data in the database instead of flat files.',
    'pro_feature_custom_routes' => 'Custom Routes',
    'pro_feature_custom_routes_description' => 'SEO metadata for custom Statamic and Laravel routes.',
    'pro_feature_custom_tokens' => 'Custom Tokens',
    'pro_feature_custom_tokens_description' => 'Register custom normalizers and value tokens for title and description inputs.',
];
