...
it('denies configure for collection SeoSets with only edit entries permission', function () {
...
it('denies configure for taxonomy SeoSets with only edit terms permission', function () {
