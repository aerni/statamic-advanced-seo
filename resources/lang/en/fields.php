...
return [
    ...
    'seo_title' => [
        'instructions' => 'Set the meta title of this :type. This defaults to the :type\'s title.',
    ...
    'seo_og_title' => [
        'instructions' => 'Set the Open Graph title of this :type. This defaults to the :type\'s meta title.',
        'default_instructions' => 'Set the default Open Graph title of your :type.',
    ],

    'seo_og_description' => [
        'instructions' => 'Set the Open Graph description of this :type. This defaults to the :type\'s meta description.',
    ...
    'seo_twitter_description' => [
        'instructions' => 'Set the Twitter description of this :type. This defaults to the :type\'s meta description.',
    ...
    'seo_section_canonical_url' => [
        'instructions' => 'Configure the canonical URL settings for this :type.',
        'default_instructions' => 'Configure the default canonical URL settings for your :type.',
    ],

    'seo_canonical_type' => [
        'instructions' => 'Where should the canonical URL for this :type point to.',
        'default_instructions' => 'Where should the default canonical URL for your :type point to.',
    ],

    'seo_canonical_entry' => [
        'instructions' => 'Link to the entry with the original content.',
        'default_instructions' => 'Link to the entry with the original content.',
    ],
    ...
    'seo_section_indexing' => [
        'instructions' => 'Configure the indexing settings for this :type.',
        'default_instructions' => 'Configure the default indexing settings for your :type.',
    ],
    ...
    'seo_section_sitemap' => [
        'instructions' => 'Configure the sitemap settings for this :type.',
        'default_instructions' => 'Configure the default sitemap settings for your :type.',
    ],

    'seo_sitemap_priority' => [
        'instructions' => 'Choose the sitemap priority of this :type. `1.0` is the most important.',
        'default_instructions' => 'Choose the default sitemap priority for your :type. `1.0` is the most important.',
    ],
    ...
    'seo_json_ld' => [
        'instructions' => 'Structured data for this :type. This will be wrapped in the appropriate script tag.',
        'default_instructions' => 'Default structured data for your :type. This will be wrapped in the appropriate script tag.',
    ],
